...
return(
    ...
    <div className='our-process'>
        ...
        <img className="stepimg" src={step1} alt="step1"></img>
        <div className='step1'>
        ...
        <img className="stepimg" src={step2} alt="step2"></img>
        <div className='step2'>
        ...
        <img className="stepimg"src={step3} alt="step3"></img>
        <div className='step3'>
        ...
        <img className='stepimg' src={step4} alt="step4"></img>
        <div className='step4'>
        ...
        <img className='stepimg' src={step5} alt="step5"></img>
        <div className='step5'>
        ...
        <img className='stepimg' src={step6} alt="step6"></img>
        <div className='step6'>
